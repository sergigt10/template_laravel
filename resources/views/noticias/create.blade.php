                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            <form class="forms-sample" method="POST" action="{{ route('noticias.store') }}" enctype="multipart/form-data" novalidate>
                                @csrf
                                @error('titulo')
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="titulo" type="text" class="form-control @error('titulo') is-invalid @enderror" id="exampleInputEmail3" placeholder="Titulo noticia" value="{{ old('titulo') }}">
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group col-xs-12">
                                                        <input name="video" type="text" class="form-control @error('video') is-invalid @enderror file-upload-info" readonly="readonly" placeholder="Video">
                                                        <span class="input-group-append">
